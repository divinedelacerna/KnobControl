...
Pod::Spec.new do |spec|
 ...
 spec.homepage     = "http://raywenderlich.com"
  ...
  spec.author             = { "Divine Cerna" => "divine.grace@razer.com" }
  # Or just: spec.author    = "Divine Cerna"
  # spec.authors            = { "Divine Cerna" => "divine.grace@razer.com" }
  # spec.social_media_url   = "https://twitter.com/Divine Cerna"
  ...
  spec.source   =  { :git: => "https://github.com/divinedelacerna/KnobControl.git", :tag => "1.0.2"}
